...
SECRET_KEY = 'django-insecure-#mwz_y4v0v-o3^z-9nku2^=%(renlhko#fuui@9c1dlw$@irf@'
...
JAZZMIN_SETTINGS = {
    ...
    "site_header": "Sistema de Atendimento",
    ...
    "icons": {
        ...
        "atendimento.Categoria": "fas fa-tags",
        "atendimento.Chamado": "fas fa-headset",
